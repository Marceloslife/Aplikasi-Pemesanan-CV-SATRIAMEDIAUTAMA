...
<body data-home-page="LOGIN.html" data-home-page-title="LOGIN" class="u-body u-xl-mode" data-lang="en">
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <header class="u-clearfix u-header u-header" id="sec-e397">
                                ...
                                <div class="u-layout-row">
                                    <div class="u-container-style u-layout-cell u-left-cell u-size-28 u-layout-cell-1">
                                        <div class="u-container-layout u-valign-middle u-container-layout-1">
                                            <div
                                                class="u-border-9 u-border-custom-color-1 u-line u-line-horizontal u-line-1">
                                            </div>
                                            <h1 class="u-text u-text-custom-color-2 u-text-1"
                                                data-animation-name="fadeIn" data-animation-duration="2000"
                                                data-animation-direction="Left">EO SATRIA MEDIA
                                                UTAMA
                                            </h1>
                                                ...
                                                <div class="carousel-inner">
                                                    ...
                                                    <div class="carousel-item active">
                                                        <video class="img-fluid" autoplay loop muted>
                                                            <source src="{{ url('Video/INTRO.mp4') }}"
                                                                type="video/mp4" />
                                                        </video>
                    ...
                    <div class="u-clearfix u-sheet u-sheet-1">
                                    ...
                                    <div class="u-container-layout u-container-layout-4">
                                        ...
                                        <CENter>
                                            <h3 class="u-text u-text-default u-text-4"
                                                ...
                                                data-animation-duration="1000">EVENT</h3>
                                        </CENter>
                        ...
                        <div class="u-container-style u-group u-palette-1-base u-shape-rectangle u-group-2"
                            ...
                            <div class="u-container-layout u-container-layout-3">
                                ...
                                <h3 class="u-hover-feature u-text u-text-default u-text-3"
                                    data-animation-name="customAnimationIn" data-animation-duration="1000"
                                    data-animation-direction="">ORDER</h3>
                            </div>
                        </div>
                                                ...
                                                <div class="u-align-left u-container-style u-layout-cell u-size-30 u-layout-cell-2"
                                                    ...
                                                    <div class="u-container-layout u-container-layout-2">
                                                        ...
                                                        <img class="u-expanded-width u-image u-image-2"
                                                            src="images/event.png" data-image-width="852"
                                                            data-image-height="735" data-animation-name="fadeIn"
                                                ...
                                                <div
                                                    ...
                                                    <div class="u-container-layout u-container-layout-3">
                                                        <img class="u-expanded-width u-image u-image-3"
                                                            src="images/event3.png" data-image-width="857"
                                                            data-image-height="628" data-animation-name="fadeIn"
                                                            data-animation-duration="2000"
                        ...
                        <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                            <div class="u-gutter-0 u-layout">
                                <div class="u-layout-row">
                                    ...
                                    <div
                                        class="u-align-justify u-container-style u-layout-cell u-size-38 u-layout-cell-2">
                                        <div class="u-container-layout u-container-layout-2">
                                            ...
                                            <div class="u-align-center u-form u-form-1">
                                                <form action="https://forms.nicepagesrv.com/Form/Process"
                                                    ...
                                                    <div class="u-form-email u-form-group">
                                                        ...
                                                        <input type="email"
                                                            placeholder="Enter a valid email address" id="email-cd2c"
                                                            name="email"
                                    ...
                                    <div
                                        ...
                                        <div class="u-container-layout u-container-layout-2">
                                            ...
                                            <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-1"
                                                src="images/instagram-logo1.png" alt=""
                                                data-image-width="1915" data-image-height="1915"
                                                data-href="https://www.instagram.com/satriamediautama_eo/">
                                        </div>
                                    </div>
                                </div>
                            </div>
