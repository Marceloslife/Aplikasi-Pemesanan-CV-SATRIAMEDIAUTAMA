...
<body class="hold-transition sidebar-mini sidebar-collapse">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <img src="images/logo.png" alt="" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Satria Media Utama</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="images/profile.png" class="img-circle elevation-2" alt="">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (Auth::user()->level == 1 || Auth::user()->level == 2)
                            <li class="nav-item">
                                <a href="/adminvieworder" class="nav-link">
                                    <i class="nav-icon fas fa-th"></i>
                                    <p>
                                        List Orderan
                                        <!-- <span class="right badge badge-danger">New</span> -->
                            ...
                            <li class="nav-item">
                                <a href="/tabelportofolio" class="nav-link">
                                    <i class="nav-icon fas fa-th"></i>
                                    <p>
                                        Portofolio
                                        <!-- <span class="right badge badge-danger">New</span> -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2022-2023 <a href="">Satria Media Utama</a>.</strong> All rights
            reserved.
        </footer>
